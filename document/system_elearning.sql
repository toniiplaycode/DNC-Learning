...
INSERT INTO `quiz_attempts` VALUES (1,1,1,'2025-04-03 03:51:29',NULL,25.00,'in_progress','2025-04-03 03:51:29','2025-04-09 09:50:37'),(2,1,1,'2025-03-29 03:52:14','2025-03-29 03:52:14',0.00,'abandoned','2025-04-03 03:52:14','2025-04-09 09:50:37'),(3,1,1,'2025-04-01 03:54:24','2025-04-01 04:14:24',75.00,'completed','2025-04-03 03:54:24','2025-04-09 09:50:37'),(4,15,12,'2025-04-01 03:54:24','2025-04-01 04:14:24',80.00,'completed','2025-04-03 03:54:24','2025-04-09 09:50:37');
...
INSERT INTO `quiz_responses` VALUES (1,1,1,3,1.00,'2025-04-03 04:03:47','2025-04-09 09:48:29'),(2,2,1,2,0.00,'2025-04-03 04:03:47','2025-04-03 04:03:47'),(3,3,1,3,1.00,'2025-04-03 04:03:47','2025-04-09 09:48:29'),(4,3,2,5,1.00,'2025-04-03 04:03:47','2025-04-03 04:03:47'),(5,3,3,10,1.00,'2025-04-03 04:03:47','2025-04-09 09:48:29'),(6,3,4,15,0.00,'2025-04-03 04:03:47','2025-04-07 09:14:52'),(7,4,48,170,1.00,'2025-04-06 01:37:18','2025-04-06 02:52:54'),(8,4,49,175,1.00,'2025-04-06 01:37:18','2025-04-06 02:52:43'),(9,4,50,180,1.00,'2025-04-06 01:37:18','2025-04-09 09:48:29'),(10,4,51,181,0.00,'2025-04-06 01:37:18','2025-04-06 02:52:43'),(11,4,52,185,1.00,'2025-04-06 01:37:18','2025-04-06 02:52:43');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_quiz_response_insert_calculate_score` AFTER INSERT ON `quiz_responses` FOR EACH ROW BEGIN
  ...
  IF NEW.question_id IS NOT NULL AND NEW.selected_option_id IS NOT NULL THEN
    -- Kiểm tra xem lựa chọn có đúng không và cập nhật điểm
    UPDATE quiz_responses
    SET score = (
      SELECT 
        CASE 
          WHEN qo.is_correct = 1 THEN 1 -- Hoặc qq.points nếu bạn muốn sử dụng điểm riêng cho mỗi câu hỏi
          ELSE 0 
        END
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `update_quiz_attempt_score` AFTER UPDATE ON `quiz_responses` FOR EACH ROW BEGIN
  DECLARE attempt_id_val BIGINT;
  DECLARE quiz_id_val BIGINT;
  
  SET attempt_id_val = NEW.attempt_id;
  
  SELECT quiz_id INTO quiz_id_val 
  FROM quiz_attempts 
  WHERE id = attempt_id_val;
  
  UPDATE quiz_attempts
  SET score = (
    SELECT COUNT(*) FROM quiz_responses 
    WHERE attempt_id = attempt_id_val AND score = 1
  ) / (
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `after_quiz_response_update_calculate_score` AFTER UPDATE ON `quiz_responses` FOR EACH ROW BEGIN
  -- Chỉ tính điểm khi có cả question_id và selected_option_id
...
INSERT INTO `reviews` VALUES (2,2,5,'course',4,'Nội dung phân tích dữ liệu khá chi tiết, nhưng cần thêm ví dụ thực tế.','2025-03-25 10:15:44','2025-03-26 02:23:53'),(3,3,3,'course',5,'Khoá học cung cấp nhiều kiến thức bổ ích về an toàn thông tin.','2025-03-25 10:15:44','2025-03-25 10:15:44'),(4,4,4,'course',4,'Bài giảng dễ hiểu, tuy nhiên phần AI nâng cao cần thêm bài tập thực hành.','2025-03-25 10:15:44','2025-03-25 10:15:44'),(5,5,2,'course',3,'Quản lý khách sạn là lĩnh vực mới với tôi, nhưng bài giảng còn khá lý thuyết.','2025-03-25 10:15:44','2025-03-25 10:15:44'),(6,1,7,'course',5,'Khóa học tuyệt vời, rất phù hợp với những ai muốn tìm hiểu về AI.','2025-03-25 10:15:44','2025-03-25 10:15:44'),(7,2,8,'course',4,'Nội dung marketing số có nhiều thông tin hay, nhưng chưa có case study thực tế.','2025-03-25 10:15:44','2025-03-25 10:15:44'),(8,3,10,'course',5,'Khoá học giúp tôi hiểu sâu về bảo mật mạng.','2025-03-25 10:15:44','2025-03-25 10:15:44'),(9,4,9,'course',4,'Khóa học tài chính doanh nghiệp cung cấp kiến thức bổ ích nhưng hơi khó.','2025-03-25 10:15:44','2025-03-25 10:15:44'),(10,5,6,'course',3,'Chiến lược kinh doanh khá hữu ích, nhưng nội dung chưa thực sự chuyên sâu.','2025-03-25 10:15:44','2025-03-25 10:15:44'),(11,9,1,'course',3,'Khóa học rất hay và ý nghĩa !','2025-04-09 02:15:16','2025-04-09 02:15:16'),(130,1,1,'course',5,'khóa học này rất hay và ý nghĩa','2025-04-09 02:50:04','2025-04-09 02:50:04');
...
-- Dump completed on 2025-04-09 17:04:59
