...
img_descriptions = {
    ...
    'Trang cá nhân tiến độ học.png': 'Màn hình giúp học viên và sinh viên theo dõi tiến độ học tập, hiển thị tỷ lệ hoàn thành.',
    'Trang cá nhân thanh toán.png': 'Màn hình hiển thị chi tiết thanh toán, lịch sử giao dịch, trạng thái học phí, và các khoản phí. Học viên và sinh viên kiểm tra, tải hóa đơn, thanh toán trực tuyến, nhận thông báo thay đổi tài chính, giúp quản lý tài chính học tập hiệu quả.',
    ...
    'Tìm kiếm thông tin.png': 'Màn hình tìm kiếm toàn bộ nội dung trong hệ thống, bao gồm khóa học, bài học, tài liệu, giảng viên, diễn đàn và thông báo. Học viên và sinh viên có thể sử dụng bộ lọc nâng cao để tìm kiếm nhanh và chính xác.',
    ...
    'Nộp bài tập.png': 'Màn hình cho phép học viên và sinh viên nộp bài tập trực tuyến, tải lên file, nhập nội dung trả lời, kiểm tra thời hạn nộp và nhận phản hồi từ giảng viên. Ngoài ra, học viên có thể xem lại các bài đã nộp, nhận thông báo khi có điểm hoặc nhận xét. Chức năng này giúp quá trình nộp và chấm bài tập trở nên minh bạch, thuận tiện và tiết kiệm thời gian.',
    'Làm bài trắc nghiệm.png': 'Màn hình cho phép học viên và sinh viên thực hiện các bài kiểm tra trắc nghiệm trực tuyến với nhiều dạng câu hỏi khác nhau. Học viên có thể xem thời gian làm bài, chọn đáp án, nộp bài và nhận kết quả ngay sau khi hoàn thành. Ngoài ra, hệ thống còn hỗ trợ lưu tạm thời, xem lại đáp án và thống kê kết quả. Chức năng này giúp đánh giá năng lực học viên một cách khách quan, nhanh chóng và hiệu quả.',
    'Kết quả bài tập.png': 'Màn hình tổng hợp kết quả các bài tập đã nộp, điểm số, nhận xét của giảng viên và trạng thái hoàn thành. Học viên và sinh viên có thể xem lại bài đã nộp, nhận phản hồi chi tiết và cải thiện kết quả học tập.',
    'Hiển thị điểm và đáp án.png': 'Màn hình hiển thị chi tiết điểm số và đáp án đúng của các bài kiểm tra trắc nghiệm. Học viên và sinh viên có thể so sánh đáp án của mình với đáp án đúng, nhận nhận xét và rút kinh nghiệm cho các lần kiểm tra sau.',
    'Đăng nhập.png': 'Màn hình đăng nhập cho học viên/sinh viên nhập tên, mật khẩu, hoặc đăng nhập qua Google để truy cập khóa học, bài tập, diễn đàn, và tiến độ. Đảm bảo an toàn, bảo mật, và phân quyền theo vai trò.',
    # 'Đăng ký khóa học.png': 'Màn hình cho phép học viên đăng ký khóa học mới, xem thông tin, học phí, xác nhận đăng ký và được chuyển trang thanh toán với ZaloPay.',
    ...
    'Danh sách giảng viên.png': 'Màn hình hiển thị danh sách tất cả giảng viên trong hệ thống, cho phép học viên và sinh viên xem thông tin, tìm kiếm theo chuyên ngành, liên hệ hoặc gửi phản hồi.',
    ...
    'Các bài tập và trắc nghiệm.png': 'Màn hình tổng hợp tất cả các bài tập và bài kiểm tra trắc nghiệm cần hoàn thành trong từng khóa học. Học viên và sinh viên có thể theo dõi hạn nộp, trạng thái hoàn thành và truy cập nhanh vào từng bài.',
    # -----------------------------Nhóm giảng viên-----------------------------
    ...
    'Quản lý lớp học thuật (thêm khóa học).png': 'Màn hình cho phép giảng viên thêm khóa học vào lớp học thuật để các sinh viên có thể tham gia khóa học.',
