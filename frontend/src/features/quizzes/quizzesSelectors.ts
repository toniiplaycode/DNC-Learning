...
export const selectInstructorQuizzes = (state: RootState) =>
  state.quizzes.instructorQuizzes;
export const selectInstructorAttempts = (state: RootState) =>
  state.quizzes.instructorAttempts;
